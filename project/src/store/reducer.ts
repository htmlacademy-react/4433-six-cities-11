...
// import {setCity, setOffersByCity, setCurrentSortType, setSelectedOffer, loadOffers, loadNearOffers, setOffersLoadingStatus, setError, setUserData, loadReviewsByOffer, loadCurrentOffer} from './action';
